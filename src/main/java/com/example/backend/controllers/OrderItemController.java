...
public class OrderItemController {
    ...
    public ResponseEntity<OrderItemResponseDTO> createOrderItem(@RequestBody OrderItemRequestDTO orderItemRequestDTO, HttpServletRequest request) {
    ...
    public ResponseEntity<List<OrderItemResponseDTO>> getAllOrderItems(HttpServletRequest request) {
